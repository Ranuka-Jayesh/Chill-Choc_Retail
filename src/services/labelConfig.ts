...
export const LABEL_SIZE_CONFIGS: Record<LabelSize, LabelSizeDefinition> = {
  '40x20': {
    ...
    description: 'Primary compact thermal retail sticker (2:1 ratio)',
    showTagline: true,
    brandFontSizePt: 7.2,
    taglineFontSizePt: 3.8,
    titleFontSizePt: 6.8,
    priceFontSizePt: 9.8,
    barcodeSvgHeight: 26,
    barcodeMaxBarWidth: 200,
    barcodeFontSizePt: 4.8,
    pagePadding: '0.4mm 1mm',
    previewWidthPx: 300,
    previewHeightPx: 150,
    previewBrandClass: 'font-serif font-black text-[20px] text-black leading-none tracking-tight',
    previewTaglineClass: 'font-sans font-normal text-[10px] text-black leading-none mt-1',
    previewTitleClass: 'font-sans font-bold text-[12.5px] text-black leading-tight mt-1',
    previewPriceClass: 'font-sans font-black text-[20px] text-black leading-none tracking-tight mt-1',
    previewBarcodeHeight: 28,
    previewBarcodeTextClass: 'font-mono font-bold text-[10.5px] text-black leading-none tracking-wider mt-1',
  },
  '30x20': {
    id: '30x20',
    name: '30 × 20 mm',
